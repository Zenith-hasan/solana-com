...
| Требование                                      | Описание                                                                                                                                                         | Приоритет |
| :---------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------- |
| Отслеживание обновлений множителя               | Отслеживайте обновления множителя для токенов, использующих расширение scaled ui amount.                                                                         | **P0**    |
| Отображение балансов ребейзинговых токенов      | Показывайте масштабированные балансы для торговли или предоставления ликвидности в пользовательском интерфейсе. (бэкенд может использовать необработанные суммы) | **P0**    |
| Поддержка действий с токенами                   | Пользователи должны вводить суммы действий, используя свои UiAmount балансы (множитель \* необработанная сумма).                                                 | **P0**    |
| Исторические действия не должны пересчитываться | Исторические действия, такие как сделки, должны отображаться с использованием точной масштабированной суммы и цены на момент действия.                           | **P1**    |
| Внутренний учет необработанных балансов         | Учитывайте необработанные балансы для транзакций в блокчейне вместо масштабированных балансов. Это будет точнее и проще в долгосрочной перспективе.              | **P1**    |
| Адаптация ценового фида                         | Везде, где используется ценовой фид для отображения текущей цены, предоставляйте масштабированную цену пользователям.                                            | **P1**    |
| Отображение графика истории цен                 | Отражайте масштабированные цены на графике цен. Это включает пересчет исторических цен в соответствии с текущим множителем.                                      | **P1**    |

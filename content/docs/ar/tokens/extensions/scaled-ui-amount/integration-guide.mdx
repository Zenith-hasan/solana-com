...
| المتطلب                                     | الوصف                                                                                                                          | الأولوية |
| :------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------- | :------- |
| تتبع تحديثات المضاعف                        | تتبع تحديثات المضاعف للرموز التي تستخدم امتداد واجهة المستخدم المقياسية.                                                       | **P0**   |
| عرض أرصدة الرموز المعاد تقييمها             | إظهار الأرصدة المقياسية للتداول أو توفير السيولة على واجهة المستخدم. (يمكن للخادم الخلفي الاستمرار في استخدام المبالغ الأولية) | **P0**   |
| دعم إجراءات الرموز                          | يجب على المستخدمين إدخال كميات الإجراءات بأرصدة واجهة المستخدم الخاصة بهم (المضاعف \* المبلغ الأولي).                          | **P0**   |
| يجب ألا يتم إعادة تقييم الإجراءات التاريخية | يجب عرض الإجراءات التاريخية مثل عمليات التداول باستخدام المبلغ المقياسي والسعر الدقيق في وقت الإجراء.                          | **P1**   |
| تتبع الأرصدة الأولية داخليًا                | تتبع الأرصدة الأولية لمعاملات البلوكتشين بدلاً من الأرصدة المقياسية. سيكون هذا أكثر دقة وأسهل في الإدارة على المدى الطويل.     | **P1**   |
| تكييف مصدر الأسعار                          | في أي مكان يتم فيه استخدام مصدر أسعار لعرض السعر الحالي، قم بتوفير السعر المقياسي للمستخدمين النهائيين.                        | **P1**   |
| عرض رسم بياني لتاريخ الأسعار                | عكس الأسعار المقياسية في الرسم البياني للسعر. يتضمن ذلك إعادة تقييم الأسعار التاريخية إلى المضاعف الحالي.                      | **P1**   |
| تقييس أساس التكلفة                          | يجب تقييس التكلفة لكل سهم إلى المضاعف الحالي.                                                                                  | **P1**   |

...
| Вимога                                      | Опис                                                                                                                                                     | Пріоритет |
| :------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------- |
| Відстеження оновлень множника               | Відстеження оновлень множника для токенів, які використовують розширення масштабованої суми в інтерфейсі.                                                | **P0**    |
| Відображення ребазованих балансів токенів   | Показувати масштабовані баланси для торгівлі або надання ліквідності в інтерфейсі. (бекенд може продовжувати використовувати сирі суми)                  | **P0**    |
| Підтримка дій з токенами                    | Кінцеві користувачі повинні вводити суми дій зі своїми балансами UiAmount (множник \* сира сума).                                                        | **P0**    |
| Історичні дії не повинні перемасштабуватися | Історичні дії, такі як торги, повинні відображатися з використанням точної масштабованої суми та ціни на момент дії.                                     | **P1**    |
| Внутрішнє відстеження сирих балансів        | Відстеження сирих балансів для транзакцій в мережі замість масштабованих балансів. Це буде точніше і простіше в управлінні в довгостроковій перспективі. | **P1**    |
| Адаптація цінового фіду                     | Будь-де, де використовується ціновий фід для відображення поточної ціни, надавати кінцевим користувачам масштабовану ціну.                               | **P1**    |

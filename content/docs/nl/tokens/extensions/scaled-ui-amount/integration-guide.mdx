...
| Vereiste                           | Beschrijving                                                                                                                                 | Prioriteit |
| :--------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------- | :--------- |
| Volg vermenigvuldigingsupdates     | Volg vermenigvuldigingsupdates voor tokens die de geschaalde ui-hoeveelheidsextensie gebruiken.                                              | **P0**     |
| Toon geherbaseerde tokensaldi      | Toon geschaalde saldi voor handel of liquiditeitsverschaffing in de UI. (backend kan nog steeds ruwe hoeveelheden gebruiken)                 | **P0**     |
| Ondersteuning voor tokenacties     | Eindgebruikers moeten actiehoeveelheden invoeren met hun UiAmount-saldi (vermenigvuldiger \* ruwe hoeveelheid).                              | **P0**     |
| Historische acties niet herschalen | Historische acties zoals transacties moeten worden weergegeven met de nauwkeurige geschaalde hoeveelheid en prijs op het moment van actie.   | **P1**     |
| Intern ruwe saldi bijhouden        | Houd ruwe saldi bij voor onchain transacties in plaats van geschaalde saldi. Dit is nauwkeuriger en eenvoudiger te beheren op lange termijn. | **P1**     |
| Aanpassing van prijsfeed           | Overal waar een prijsfeed wordt gebruikt om de huidige prijs weer te geven, geef de geschaalde prijs aan eindgebruikers.                     | **P1**     |

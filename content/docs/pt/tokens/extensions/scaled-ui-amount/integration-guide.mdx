...
| Requisito                                  | Descrição                                                                                                                                  | Prioridade |
| :----------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------- | :--------- |
| Acompanhar Atualizações de Multiplicador   | Acompanhar atualizações de multiplicador para tokens que usam a extensão de quantidade escalada na interface.                              | **P0**     |
| Exibir Saldos de Token Rebaseados          | Mostrar saldos escalados para negociação ou provisão de liquidez na interface. (backend ainda pode usar quantidades brutas)                | **P0**     |
| Suporte para Ações de Token                | Usuários finais devem inserir quantidades de ação com seus saldos UiAmount (multiplicador \* quantidade bruta).                            | **P0**     |
| Ações Históricas Não Devem Ser Reescaladas | Ações históricas como negociações devem ser exibidas usando a quantidade e preço escalados precisos no momento da ação.                    | **P1**     |
...
| Escalar base de custo                      | Custo por ação deve ser escalado para o multiplicador atual.                                                                               | **P1**     |

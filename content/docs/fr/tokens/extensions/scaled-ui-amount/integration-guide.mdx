...
| Exigence                                                        | Description                                                                                                                                               | Priorité |
| :-------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------- | :------- |
| Suivi des mises à jour du multiplicateur                        | Suivre les mises à jour du multiplicateur pour les tokens qui utilisent l'extension de montant UI mis à l'échelle.                                        | **P0**   |
| Affichage des soldes de tokens rebasés                          | Afficher les soldes mis à l'échelle pour le trading ou la fourniture de liquidité sur l'interface. (le backend peut toujours utiliser les montants bruts) | **P0**   |
| Support des actions sur les tokens                              | Les utilisateurs finaux doivent saisir les montants d'action avec leurs soldes UiAmount (multiplicateur \* montant brut).                                 | **P0**   |
| Les actions historiques ne doivent pas être remises à l'échelle | Les actions historiques comme les transactions doivent être affichées en utilisant le montant et le prix mis à l'échelle précis au moment de l'action.    | **P1**   |
| Suivi interne des soldes bruts                                  | Suivre les soldes bruts pour les transactions onchain au lieu des soldes mis à l'échelle. Ce sera plus précis et plus facile à gérer à long terme.        | **P1**   |
...
| Affichage du graphique d'historique des prix                    | Refléter les prix mis à l'échelle dans le graphique de prix. Cela inclut la remise à l'échelle des prix historiques au multiplicateur actuel.             | **P1**   |
| Mise à l'échelle du prix de revient                             | Le coût par action doit être mis à l'échelle selon le multiplicateur actuel.                                                                              | **P1**   |

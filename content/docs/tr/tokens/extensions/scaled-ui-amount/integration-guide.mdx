...
| Yeniden Tabanlı Token Bakiyelerini Göster   | Kullanıcı arayüzünde ticaret veya likidite sağlama için ölçeklendirilmiş bakiyeleri göster. (backend hala ham miktarları kullanabilir)           | **P0**  |
| Token İşlemleri için Destek                 | Son kullanıcılar işlem miktarlarını UiAmount bakiyeleriyle girmelidir (çarpan \* ham miktar).                                                    | **P0**  |
| Geçmiş İşlemler Yeniden Ölçeklendirilmemeli | Ticaret gibi geçmiş işlemler, işlem zamanındaki doğru ölçeklendirilmiş miktar ve fiyat kullanılarak gösterilmelidir.                             | **P1**  |
| Dahili olarak ham bakiyeleri takip et       | Ölçeklendirilmiş bakiyeler yerine zincir üstü işlemler için ham bakiyeleri takip et. Bu uzun vadede daha doğru ve yönetimi daha kolay olacaktır. | **P1**  |
| Fiyat Beslemesi Adaptasyonu                 | Mevcut fiyatı göstermek için bir fiyat beslemesinin kullanıldığı her yerde, son kullanıcılara ölçeklendirilmiş fiyatı sağla.                     | **P1**  |

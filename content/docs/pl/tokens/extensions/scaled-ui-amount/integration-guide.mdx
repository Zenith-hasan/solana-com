...
---CODE-PLACEHOLDER-7fcda41998760beefe552746d660e453---
...
| Wymaganie                                       | Opis                                                                                                                                                       | Priorytet |
| :---------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------- |
| Śledzenie aktualizacji mnożnika                 | Śledzenie aktualizacji mnożnika dla tokenów korzystających z rozszerzenia scaled ui amount.                                                                | **P0**    |
| Wyświetlanie zrebalansowanych sald tokenów      | Pokazywanie zrebalansowanych sald dla handlu lub dostarczania płynności w interfejsie użytkownika. (backend nadal może używać surowych wartości)           | **P0**    |
| Obsługa akcji tokenów                           | Użytkownicy końcowi powinni wprowadzać kwoty akcji przy użyciu swoich sald UiAmount (mnożnik \* surowa kwota).                                             | **P0**    |
| Historyczne akcje nie powinny być przeskalowane | Historyczne akcje, takie jak transakcje, powinny być wyświetlane z dokładnymi przeskalowanymi kwotami i cenami z momentu akcji.                            | **P1**    |
| Wewnętrzne śledzenie surowych sald              | Śledzenie surowych sald dla transakcji on-chain zamiast przeskalowanych sald. Będzie to dokładniejsze i łatwiejsze do zarządzania w dłuższej perspektywie. | **P1**    |
| Adaptacja źródła cen                            | W każdym miejscu, gdzie źródło cen jest używane do wyświetlania bieżącej ceny, należy dostarczyć użytkownikom końcowym przeskalowaną cenę.                 | **P1**    |
| Wyświetlanie wykresu historii cen               | Odzwierciedlenie przeskalowanych cen na wykresie cen. Obejmuje to przeskalowanie historycznych cen do bieżącego mnożnika.                                  | **P1**    |

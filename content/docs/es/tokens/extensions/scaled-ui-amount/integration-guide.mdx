...
| Requisito                                       | Descripción                                                                                                                                             | Prioridad |
| :---------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ | :-------- |
| Seguimiento de actualizaciones de multiplicador | Seguimiento de actualizaciones de multiplicador para tokens que utilizan la extensión de cantidad escalada en la interfaz.                              | **P0**    |
| Mostrar saldos de tokens rebasados              | Mostrar saldos escalados para operaciones o provisión de liquidez en la interfaz. (el backend puede seguir usando cantidades sin procesar)              | **P0**    |
| Soporte para acciones de tokens                 | Los usuarios finales deben introducir cantidades de acción con sus saldos UiAmount (multiplicador \* cantidad sin procesar).                            | **P0**    |
| Las acciones históricas no deben reescalarse    | Las acciones históricas como operaciones deben mostrarse utilizando la cantidad y precio escalados precisos en el momento de la acción.                 | **P1**    |
| Seguimiento interno de saldos sin procesar      | Seguimiento de saldos sin procesar para transacciones en cadena en lugar de saldos escalados. Esto será más preciso y fácil de gestionar a largo plazo. | **P1**    |
| Adaptación de fuente de precios                 | En cualquier lugar donde se utilice una fuente de precios para mostrar el precio actual, proporcionar el precio escalado a los usuarios finales.        | **P1**    |
...
| Escalar base de costos                          | El costo por acción debe escalarse al multiplicador actual.                                                                                             | **P1**    |
